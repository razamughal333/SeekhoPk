  ...
  return (
    <Layout>
      <section className="mx-auto grid min-h-[70vh] max-w-4xl grid-cols-1 items-center gap-10 px-6 py-16 md:grid-cols-2">
        ...
        <p className="mt-2 font-body text-ink/60">Join SeekhoPakistan as a student or instructor.</p>

        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
          <label className="flex flex-col gap-1.5">
            <span className="font-body text-sm font-medium text-ink">Full name</span>
            <input
              type="text"
              required
              value={name}
          ...
          <fieldset className="flex flex-col gap-1.5">
            <legend className="font-body text-sm font-medium text-ink">I am joining as a</legend>
